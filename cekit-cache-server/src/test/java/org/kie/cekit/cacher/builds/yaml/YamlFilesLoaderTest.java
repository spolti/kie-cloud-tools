...
public class YamlFilesLoaderTest {
    ...
    public void testModulesYamlFile() {
        ...
        Assertions.assertEquals("[Env{name='JBOSS_PRODUCT', value='rhdm-kieserver'}, Env{name='RHDM_KIESERVER_VERSION', value='7.6.0'}, Env{name='PRODUCT_VERSION', value='7.6.0'}, Env{name='KIE_SERVER_DISTRIBUTION_ZIP', value='kie_server_distribution.zip'}]", modules.getEnvs().toString());

...
public class BuildUpdatesInterceptorTest {
    ...
    public void newBUildDateDetectedTest() {
        ...
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhpam-7.5.0.PAM-redhat-" + buildDate + "-add-ons.zip", null, buildDate, null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhpam-7.5.0.PAM-redhat-" + buildDate + "-business-central-eap7-deployable.zip", null, buildDate,null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhpam-7.5.0.PAM-redhat-" + buildDate + "-monitoring-ee7.zip", null, buildDate,null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhpam-7.5.0.PAM-redhat-" + buildDate + "-kie-server-ee8.zip", null, buildDate,null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhdm-7.5.0.DM-redhat-" + buildDate + "-add-ons.zip", null, buildDate,null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhdm-7.5.0.DM-redhat-" + buildDate + "-decision-central-eap7-deployable.zip", null, buildDate,null, null));
        buildDateUpdatesInterceptor.onNewBuildReceived(new PlainArtifact("rhdm-7.5.0.DM-redhat-" + buildDate + "-kie-server-ee8.zip", null, buildDate,null, null));

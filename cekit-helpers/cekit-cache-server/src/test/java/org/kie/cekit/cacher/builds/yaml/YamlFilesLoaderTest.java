...
public class YamlFilesLoaderTest {
    ...
    public void testModulesYamlFile() {
        ...
        Assertions.assertEquals("[Artifact{name='KIE_SERVER_DISTRIBUTION_ZIP', url='null', target='kie_server_distribution.zip', md5='03bc4e80d0945994c4e9beb9e756e0ab'}, Artifact{name='slf4j-simple.jar', url='null', target='slf4j-simple.jar', md5='51c319582c16a07c21e41737e45cb03a'}]", modules.getArtifacts().toString());
